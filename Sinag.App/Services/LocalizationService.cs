...
public class LocalizationService : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Strings = new()
    {
        ["fil"] = new()
        {
            ...
            ["Review_TotalAmount"] = "TOTAL AMOUNT DUE (opsyonal)",
            ...
            ["Manual_TotalAmount"] = "TOTAL AMOUNT DUE (opsyonal)",
        ...
        ["en"] = new()
        {
            ...
            ["Review_BillingMonth"] = "BILLING MONTH",
            ["Review_GenCharge"] = "GENERATION CHARGE",
            ["Review_TotalAmount"] = "TOTAL AMOUNT DUE (optional)",
            ...
            ["Manual_GenChargeLabel"] = "GENERATION CHARGE (PER KWH)",
            ["Manual_TotalAmount"] = "TOTAL AMOUNT DUE (optional)",
        ...
        ["ceb"] = new()
        {
            ...
            ["Review_GenCharge"] = "GENERATION CHARGE",
            ["Review_TotalAmount"] = "TOTAL NGA BAYRUNON (opsyonal)",
            ...
            ["Manual_GenChargeLabel"] = "GENERATION CHARGE (PER KWH)",
            ["Manual_TotalAmount"] = "TOTAL NGA BAYRUNON (opsyonal)",
